    ...
    public partial class ExpenseRegister : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < expenseEntryCount - 1; i++)
            {
                ...
                expenseEntry.ExpenseRegisterProgress = "DONE";
                expenseEntry.completedDate = DateTime.Now.ToString("yyyy/MM/dd");
        ...
        {
            ExcelAppend.ExportNotQualityRegister((int)ExcelAppend.DocumentType.ExpenseRegister, dataGridViewExpenseRegister);
        }
